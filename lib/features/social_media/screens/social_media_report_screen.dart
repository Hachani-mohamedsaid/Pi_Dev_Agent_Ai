...
class SocialMediaReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
      '[SocialCampaign][Report] campaignResult received: ${result.campaignResult}',
    );
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildReportHeader(dateStr, isDark),
                      const SizedBox(height: 24),
                      _sectionTitle('Campaign Report', isDark),
                      const SizedBox(height: 12),
                      _buildFullReportSection(isDark),
                      const SizedBox(height: 24),
                    ],
                  ),
                ),
  ...
  Widget _buildReportHeader(String dateStr, bool isDark) {
    return Container(
  ...
  Widget _buildFullReportSection(bool isDark) {
    ...
    return Container(
      ...
      child: SelectableText(
        ...
        style: TextStyle(
          fontSize: 13,
          color: isDark
              ? AppColors.textCyan200.withOpacity(0.78)
              : const Color(0xFF3F6983),
          height: 1.6,
        ),
      ),
