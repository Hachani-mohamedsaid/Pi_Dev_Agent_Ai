...
String _randomRoomId() =>
    List.generate(6, (_) => _chars[Random().nextInt(_chars.length)]).join();
...
class MeetingHubScreen extends StatelessWidget {
    ...
    return Container(
          ...
          child: Column(
            children: [
              ...
              _buildActionButton(
                context,
                label: S.of(context).startMeeting,
              ...
              _buildActionButton(
                context,
                label: S.of(context).joinMeeting,
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isPrimary
                ? null
                : Border.all(color: AppColors.cyan500.withOpacity(0.35)),
          ),
          child: Row(
  ...
  Widget _buildRecentMeetingCard(
    ...
    return GestureDetector(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          m.date,
                          style: metaStyle.copyWith(color: metaColor),
                        ),
                      ],
                    ),
                    Row(
        ...
        .animate()
        .fadeIn(delay: 400.ms + (index * 80).ms)
