...
class _FinancePageState extends State<FinancePage> {
  ...
  String _friendlyFinanceError(Object error) {
    ...
    if (msg.contains('Unexpected end of JSON input') ||
        msg.contains('FormatException')) {
      return AppStrings.tr(context, 'financeTemporarilyUnavailable');
    }
    if (msg.contains('User not logged in')) {
      return AppStrings.tr(context, 'financeSignInAgain');
    }
    return AppStrings.tr(context, 'financeUnableToLoad');
  }
  ...
  Future<void> _loadFinanceData() async {
    ...
    try {
      ...
      setState(() {
        _errorMessage = _friendlyFinanceError(e);
        _isLoading = false;
      });
    }
  }
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppStrings.tr(context, 'loadingFinanceData'),
                        style: TextStyle(
                          color: isDark
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppStrings.tr(context, 'failedToLoadFinanceData'),
                          style: TextStyle(
                            fontSize: 20,
            ...
            children: [
                ...
                child: PieChart(
                  PieChartData(
                    ...
                    sections: (_categories ?? []).asMap().entries.map((entry) {
                      ...
                      final percentage =
                          double.tryParse(
                            category['percentage'] as String? ?? '0',
                          ) ??
                          0.0;
              ...
              ...List.generate((_categories ?? []).length, (index) {
                ...
                final categoryName =
                    category['category'] as String? ?? 'Unknown';
                final percentage =
                    double.tryParse(category['percentage'] as String? ?? '0') ??
                    0.0;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: List.generate((_daySpending ?? []).length, (index) {
                  final day = _daySpending![index];

                  final dayName = day['day'] as String? ?? '';
                  final total =
                      double.tryParse(day['total'] as String? ?? '0') ?? 0.0;
