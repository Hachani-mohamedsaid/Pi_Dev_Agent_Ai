...
class _HistoryPageState extends State<HistoryPage> {
  ...
  final List<AIAction> _actions = [
    AIAction(
      ...
      reason:
          'You usually decline meetings after 17:00, so this was flagged as optional and better suited for morning hours when you\'re most productive.',
    ),
    AIAction(
      id: 2,
      ...
      reason:
          'Both meetings had overlapping topics and participants. Combining them would save 30 minutes and reduce context switching.',
    ),
    AIAction(
      id: 3,
      ...
      reason:
          'This type of meeting is typically low priority based on your past decisions, and you had a full morning scheduled.',
    ),
    AIAction(
      id: 4,
      ...
      reason:
          'You had a 3-hour gap with no meetings, which historically leads to scattered work. Focus time helps maintain productivity.',
    ),
    AIAction(
      id: 5,
      ...
      reason:
          'Your inbox had accumulated messages. Prioritization helps you address urgent items first during your morning review.',
    ),
  ];
