...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _fetchLocationSuggestions(String text) async {
    ...
    if (!mounted) return;
    final singleMatch =
        list.length == 1 && list.first.displayName == text.trim();
    setState(() {
  ...
  void _onLocationTextChanged() {
    ...
    _suggestionsDebounceTimer = Timer(
    ...
    if (imgbbApiKey.isEmpty) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Ajoute la clé ImgBB dans lib/core/config/imgbb_config.dart pour enregistrer la photo.',
            ),
    ...
    try {
      ...
      if (url == null || !mounted) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(AppStrings.tr(context, 'uploadFailed')),
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppStrings.tr(context, 'photoUpdated')),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              widget.controller.error ?? S.of(context).failedToSavePhoto,
            ),
            backgroundColor: Colors.red,
          ),
        );
  ...
  Future<void> _handleSave() async {
    ...
    final success = await widget.controller.updateProfile(
      ...
      role: _bioController.text.trim().isEmpty
          ? null
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            widget.controller.error ?? S.of(context).profileUpdateError,
          ),
          backgroundColor: Colors.red,
        ),
      );
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomTextField(
                            ...
                            hint: S.of(context).enterYourPhone,
                      ...
                      Column(
                            ...
                            children: [
                              CustomTextField(
                                ...
                                hint: S.of(context).typeToSearchCities,
                              ...
                              if (openWeatherApiKey.isNotEmpty) ...[
                                if (_suggestionsLoading ||
                                    ...
                                    (_lastLocationQueryEmpty != null &&
                                        _lastLocationQueryEmpty!.length >=
                                            2)) ...[
                                  ...
                                  child: BackdropFilter(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: S.of(context).bioRoleHint,
                                        hintStyle: TextStyle(
                                          color: AppColors.textCyan200
                                              .withOpacity(0.3),
                                          fontSize: isMobile ? 15 : 16,
