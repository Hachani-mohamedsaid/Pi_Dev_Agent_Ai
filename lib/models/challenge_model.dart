...
List<Challenge> getMockChallenges() {
  return [
    Challenge(
      ...
      requiresVoice: true,
      longDescription: 'Use voice-to-text to compose and send an email directly from AVA assistant.',
      steps: const [
        'Open AVA Chat',
    ...
    Challenge(
      ...
      longDescription: 'Spread the word about AVA and get your friends to download it.',
      steps: const [
    ...
    Challenge(
      ...
      longDescription: 'Complete your profile with all details including photo for a professional appearance.',
      steps: const [
    ...
    Challenge(
      ...
      longDescription: 'Use the full meeting intelligence pipeline to prepare and analyze investor meetings.',
      steps: const [
    ...
    Challenge(
      ...
      longDescription: 'Grow the AVA community by inviting someone and having them use the platform.',
      steps: const [
    ...
    Challenge(
      ...
      longDescription: 'Unlock premium features including advanced AI analysis, priority support, and more.',
      steps: const [
        'Go to Subscription',
        'Choose premium plan',
        'Complete payment',
    ...
    Challenge(
      ...
      longDescription: 'Build a habit by using AVA every single day for a full week.',
      steps: const [
        'Log in today',
        'Log in tomorrow',
    ...
    Challenge(
      ...
      longDescription: 'Engage deeply with AVA\'s AI for insights and assistance on various topics.',
      steps: const [
        'Open Chat',
    ...
    Challenge(
      ...
      longDescription: 'Advanced challenge: Use AVA\'s API to create custom integrations.',
      steps: const [
    ...
    Challenge(
      ...
      longDescription: 'Discover and unlock various achievements throughout the app.',
      steps: const [
...
List<UserProfile> getMockLeaderboard() {
  return [
    const UserProfile(
      ...
      totalPoints: 2450,
      completedChallengeIds: ['ch_voice_email', 'ch_social_share', 'ch_profile_update', 'ch_meeting_complete', 'ch_premium_upgrade'],
      rank: 1,
      isPremium: true,
    ),
    const UserProfile(
      ...
      totalPoints: 2100,
      completedChallengeIds: ['ch_voice_email', 'ch_social_share', 'ch_profile_update', 'ch_meeting_complete'],
      rank: 2,
      isPremium: true,
    ),
    const UserProfile(
      ...
      totalPoints: 1850,
      completedChallengeIds: ['ch_voice_email', 'ch_profile_update', 'ch_daily_streak'],
      rank: 3,
      isPremium: false,
    ),
    const UserProfile(
      ...
      totalPoints: 1620,
      completedChallengeIds: ['ch_social_share', 'ch_meeting_complete', 'ch_ai_interaction'],
      rank: 4,
      isPremium: false,
    ),
    const UserProfile(
      ...
      totalPoints: 1420,
      completedChallengeIds: ['ch_profile_update', 'ch_daily_streak', 'ch_ai_interaction'],
      rank: 5,
      isPremium: false,
    ),
    const UserProfile(
