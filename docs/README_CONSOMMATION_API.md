...
- **[CONSOMMATION_API_FLUTTER.md](./CONSOMMATION_API_FLUTTER.md)** – Résumé détaillé des endpoints et modèles.
- **[FLUTTER_API_CONSOMMATION_PROFILE.md](./FLUTTER_API_CONSOMMATION_PROFILE.md)** – Profil dynamique et PATCH /auth/me.
